            ...
            <div class="row" id="contact-user">
                <div class="col-md-5">
                    <div class="contact-info">
                        ...
                        <ul>
                            <li><span class="span-info"><i class="glyphicon glyphicon-map-marker"></i> Location:</span> Renton, WA.<br /><br /></li>
                            <li><span class="span-info"><i class="glyphicon glyphicon-envelope"></i> Email:</span> cknoll2@mail.greenriver.edu</li>
                            <!--<li><span class="span-info"><i class="glyphicon glyphicon-phone"></i> Phone:</span> +123 456 789 111</li>-->
                            <li><span class="span-info"><i class="glyphicon glyphicon-globe"></i> Website:</span> www.chrisknoll.com</li>
                            <li><span class="span-info"><i class="glyphicon glyphicon-comment"></i> Skype:</span> cknoll3</li>
                    ...
                    <div class="title_content tiltle_contacts" style="float: none;">
                        <div class="text_content">Connect with me</div>
                        <div class="clear"></div>
                    </div>
