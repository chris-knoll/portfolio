    ...
    <div class="row top-p">
       <div class="col-md-6 profile-l">
            ...
            <div class="title_content">
                <div class="text_content">chris knoll</div>
                <div class="clear"></div>
            </div>
            ...
            <ul class="about">
                ...
                <li>
                    ...
                    <label>Name</label>
                    <span class="value">Chris Knoll</span>
                    <div class="clear"></div>
                </li>
                ...
                <li>
                    ...
                    <span class="value">Renton, WA</span>
                    <div class="clear"></div>
                </li>
                ...
                <li>
                    ...
                    <label>Email</label>
                    <span class="value">cknoll2@mail.greenriver.edu</span>
                    <div class="clear"></div>
                </li>
                ...
                <li>
                    ...
                    <label>Website</label>
                    <span class="value"><a href="#" target="_blank">www.chrisknoll.com</a></span>
                    <div class="clear"></div>
                </li>
            ...
            <p style="margin-bottom:20px">
                ...
                I am an aspiring software developer currently working towards my BAS in Software Development at Green River College.  I am most proud of my group work done in Web Development Frameworks: my group created a website for the Kent Food Bank that is now live.  I enjoy helping others and am continuing to support the site for the Kent Food Bank.
            </p>
       ...
       <div class="col-md-6 profile-r">
            ...
            <div class="cycle-slideshow">
                <img src="./images/kfbmain.png" alt="Kent Food Bank Group Project Site" />
            </div>
