    ...
    <div class="row">
       ...
       <div class="col-md-6">
            ...
            <div class="title_content" style="float: none;">
                <div class="text_content">Web Technologies</div>
                <div class="clear"></div>
            </div>
            <!-- /.title_content -->
            ...
            <!-- .title_content -->
            <div class="title_content" style="float: none;">
                <div class="text_content">Programming Languages</div>
                <div class="clear"></div>
            </div>
            <!-- /.title_content -->
       ...
       <div class="col-md-6 resume-left">
            ...
            <ul class="attributes">
                <li class="first">
                    <h5>BAS Software Development <span class="duration"><i class="fa fa-calendar color"></i> 2016 - 2017</span></h5>
                    <h6><span class="fa fa-book"></span> Green River College</h6>
                    <p>Develop stable, robust, secure, and efficient code following best practices in data design and software construction. Troubleshoot technical defects from identification through resolution.</p>
                </li>
                <li>
                    <h5>Associate of Arts <span class="duration"><i class="fa fa-calendar color"></i> 2008 - 2012</span></h5>
                    <h6><span class="fa fa-book"></span> Highline Community College</h6>
                    <p>Emphasis in Computer Science.</p>
                </li>
            </ul>
            <!-- /.attributes -->
            <br>
            ...
            <ul class="attributes">
                <li class="first">
                    <h5>Office Manager <span class="duration"><i class="fa fa-calendar color"></i> 2014 - 2016</span></h5>
                    <h6><span class="fa fa-briefcase"></span> Elite Line Services</h6>
                    <p>Responsible for payroll, labor tracking, budget reporting, and invoicing for a multi-million dollar contract with 60+ employees across multiple sites.</p>
                </li>
                <!--
                <li>
